...
from .apis import BlogListView, UserBlogList, blog_update_delete, Group_list_create, read_update_delete_group, Read_topics
...
urlpatterns = [
  ...
  path('topics/', Read_topics, name='topics'),
]
